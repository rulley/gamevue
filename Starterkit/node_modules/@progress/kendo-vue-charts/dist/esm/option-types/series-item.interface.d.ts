...
export interface Series {
     ...
     */
    missingValues?: 'gap' | 'interpolate' | 'zero' | string;
    /**
    ...
    startAngle?: number;
    /**
     * The `lineStyle` option is supported when [`series.type`]({% slug api_charts_chartseriesitemprops %}#toc-type) is set to `"line"`, `"scatterLine"`, `"radarLine"`, or `"polarLine"`.
     *
     * The supported values are:

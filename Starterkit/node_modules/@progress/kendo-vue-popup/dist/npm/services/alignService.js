...
var AlignService = /** @class */ (function () {
    ...
    AlignService.prototype.absoluteRect = function (anchor, element, offset) {
        var dom = this._dom;
        var rect = (0, util_1.eitherRect)(dom.offset(anchor), offset);
        var stackingOffset = dom.stackingElementOffset(element);
        var removedOffset = (0, util_1.removeStackingOffset)(rect, stackingOffset);
    ...
    AlignService.prototype.relativeRect = function (anchor, element, offset) {
        return (0, util_1.eitherRect)(this._dom.position(anchor, element), offset);
    };
    return AlignService;
}());
